            ...
            <div class=" container">
                <div class="row">
                    <div class="clearfix col-md-7 clear-padding copyright">
                        <p>Copyright © 2021 by Ralph John Patinio. All Rights Reserved.</p>
                    </div>
                    <div class="clearfix footer-icon-bottom col-md-5 float-right clear-padding">
                        <div class="icon_logo_footer float-right">
                            <img src="{{ asset('assets/img/image_payment_footer-min.png') }}" alt="">
                        </div>
                    </div>
                </div>
            </div>
...
<script src="{{ asset('assets/js/sync_owl_carousel.js') }}" defer=""></script>
