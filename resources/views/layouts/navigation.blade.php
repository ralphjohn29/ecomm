            ...
            <div class="row">
                <div class=" header-top">
                    <p class="contact_us_header col-md-4 col-xs-12 col-sm-3 clear-margin">
                        <img src="{{ asset('assets/img/icon_phone_top.png') }}" alt="Icon Phone Top Header" /> Call us <span class="text-red bold">070-7782-7137</span>
                    </p>
            ...
            <div class="row">
                <div class="clearfix header-content full-width relative">
                    ...
                    <div class="clearfix logo">
                        <a href="#"><img alt="Logo" src="{{ asset('assets/img/logo.png') }}" /></a>
                    </div>
                    ...
                    <div class="clearfix cart-website absolute" onclick="showCartBoxDetail()">
                        <img alt="Icon Cart" src="{{ asset('assets/img/icon_cart.png') }}" />
