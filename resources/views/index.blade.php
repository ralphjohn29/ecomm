                ...
                <div class="clearfix relative menu-slide clear-padding bottom-margin-default">
                        ...
                        <ul>
                            ...
                            @section('category-sidebar')
                                @foreach($categories as $category)
                                    <li><a href="#"><img src="{{ asset('category/images/'.$category->image) }}"
                                                         alt="Icon {{ $category->category_name }}"/>
                                            <p>{{ $category->category_name }}</p></a></li>
                                @endforeach
                            @endsection
                            ...
                            <li><a href="#"><img src="{{ asset('assets/img/icon_food.png') }}" alt="Icon Food"/>
                                    <p>Food</p></a></li>
                            <li><a href="#"><img src="{{ asset('assets/img/icon_mobile.png') }}"
                                                 alt="Icon Mobile & Tablet"/>
                                    <p>Mobile & Tablet</p></a></li>
                            <li><a href="#"><img src="{{ asset('assets/img/icon_electric.png') }}"
                                                 alt="Icon Electric Appliances"/>
                                    <p>Electric Appliances</p></a></li>
                            <li><a href="#"><img src="{{ asset('assets/img/icon_computer.png') }}"
                                                 alt="Icon Electronics & Technology"/>
                                    <p>Electronics & Technology</p></a></li>
                            <li><a href="#"><img src="{{ asset('assets/img/icon_fashion.png') }}"
                                                 alt="Icon Fashion"/>
                                    <p>Fashion</p></a></li>
                            <li><a href="#"><img src="{{ asset('assets/img/icon_health.png') }}"
                                                 alt="Icon Health & Beauty"/>
                                    <p>Health & Beauty</p></a></li>
                            <li><a href="#"><img src="{{ asset('assets/img/icon_mother.png') }}"
                                                 alt="Icon Mother & Baby"/>
                                    <p>Mother & Baby</p></a></li>
                            <li><a href="#"><img src="{{ asset('assets/img/icon_book.png') }}"
                                                 alt="Icon Books & Stationery"/>
                                    <p>Books & Stationery</p></a></li>
                            <li><a href="#"><img src="{{ asset('assets/img/icon_tablet.png') }}"
                                                 alt="Icon Home & Life"/>
                                    <p>Home & Life</p></a></li>
                            <li><a href="#"><img src="{{ asset('assets/img/icon_sport.png') }}"
                                                 alt="Icon Sports & Outdoors"/>
                                    <p>Sports & Outdoors</p></a></li>
                            <li><a href="#"><img src="{{ asset('assets/img/icon_auto.png') }}"
                                                 alt="Icon Auto & Moto"/>
                                    <p>Auto & Moto</p></a></li>
                        </ul>
                    </div>
                    ...
                    <div class="clearfix slide-box-home slide-v1 relative">
                        <div class="clearfix slide-home owl-carousel owl-theme">
                            ...
                            <div class="item"><img src="{{ asset('assets/img/slide_2.png') }}"
                                                   alt="Banner Header 2">
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="clearfix title-box full-width bottom-margin-default border bg-white">
                        <div class="clearfix name-title-box title-hot-bg relative">
                            <img src="{{ asset('assets/img/icon_percent.png') }}" class="absolute"
                                 alt="Icon Hot Deals"/>
                            <p>good deal today</p>
                        </div>
                        <div class="clearfix menu-title-box bold uppercase">
                            <ul>
                                ...
                                <li><a onclick="showBoxCateHomeByID('#food','.good-deal-product')"
                                       href="javascript:;">food</a>
                                </li>
                            ...
                            <div class="good-deal-product animate-default active-box-category hidden-content-box"
                                ...
                                <div class="owl-carousel owl-theme">
                                    <div class=" product-son ">
                                        <div class="clearfix image-product relative animate-default">
                                            <div class="center-vertical-image">
                                                <img src="{{ asset('assets/img/img_product.png') }}"
                                                     alt="Product . . ."/>
                                            </div>
                                        ...
                                        <p class="clearfix price-product"><span class="price-old">$700</span> $350
                                        </p>
                                    </div>
                                    <div class=" product-son ">
                                        <div class="clearfix image-product relative animate-default">
                                            <div class="center-vertical-image">
                                                <img src="{{ asset('assets/img/product_home_1.png') }}"
                                                     alt="Product . . ."/>
                                            </div>
                                            <ul class="option-product animate-default">
                                                <li class="relative"><a href="#"><i
                                    ...
                                    <div class="clearfix product-son ">
                                        <div class="clearfix image-product relative animate-default">
                                            <div class="center-vertical-image">
                                                <img src="{{ asset('assets/img/product_home_2.png') }}"
                                                     alt="Product . . ."/>
                                            </div>
                                            <ul class="option-product animate-default">
                                                <li class="relative"><a href="#"><i
                                    ...
                                    <div class="clearfix product-son ">
                                        <div class="clearfix image-product relative animate-default">
                                            <div class="center-vertical-image">
                                                <img src="{{ asset('assets/img/product_home_3.png') }}"
                                                     alt="Product . . ."/>
                                            </div>
                                            <ul class="option-product animate-default">
                                                <li class="relative"><a href="#"><i
                            ...
                            <div class="good-deal-product animate-default hidden-content-box" id="food">
                                ...
                                <div class="owl-carousel owl-theme">
                                    <div class=" product-son ">
                                        <div class="clearfix image-product relative animate-default">
                                            <div class="center-vertical-image">
                                                <img src="{{ asset('assets/img/product_home_8-min.png') }}"
                                                     alt="Product . . ."/>
                                            </div>
                                            <ul class="option-product animate-default">
                                                <li class="relative"><a href="#"><i
                                    ...
                                    <div class=" product-son ">
                                        <div class="clearfix image-product relative animate-default">
                                            <div class="center-vertical-image">
                                                <img src="{{ asset('assets/img/product_home_9-min.png') }}"
                                                     alt="Product . . ."/>
                                            </div>
                                            <ul class="option-product animate-default">
                                                <li class="relative"><a href="#"><i
                                    ...
                                    <div class="clearfix product-son ">
                                        <div class="clearfix image-product relative animate-default">
                                            <div class="center-vertical-image">
                                                <img src="{{ asset('assets/img/product_home_15-min.png') }}"
                                                     alt="Product . . ."/>
                                            </div>
                                            <ul class="option-product animate-default">
                                                <li class="relative"><a href="#"><i
                                    ...
                                    <div class="clearfix product-son ">
                                        <div class="clearfix image-product relative animate-default">
                                            <div class="center-vertical-image">
                                                <img src="{{ asset('assets/img/product_home_10-min.png') }}"
                                                     alt="Product . . ."/>
                                            </div>
                                            <ul class="option-product animate-default">
                                                <li class="relative"><a href="#"><i
                            ...
                            <div class="good-deal-product animate-default hidden-content-box" id="home-life">
                                ...
                                <div class="owl-carousel owl-theme">
                                    ...
                                    <div class="clearfix product-son ">
                                        ...
                                        <p class="title-product clearfix full-width title-hover-black animate-default">
                                            <a class="animate-default" href="#">Nostrud percipit definitiones</a>
                                        </p>
                                        <p class="clearfix price-product"><span class="price-old">$700</span> $350
                                        </p>
                                    </div>
            ...
            <div class="row">
                <div class="clearfix title-box full-width border">
                    <div class="clearfix name-title-box title-category title-jungle-green-bg relative">
                        <img alt="Icon Mobile & Tablet" src="{{ asset('assets/img/icon_mobile.png') }}"
                             class="absolute"/>
                        <p>mobile & tablet</p>
                    </div>
                    <div class="clearfix menu-title-box bold uppercase">
                        <ul>
                            ...
                            <li><a onclick="showBoxCateHomeByID('#tablet','.box-mobile-content')"
                                   href="javascript:;">Tablet</a>
                            </li>
                            ...
                            <li><a onclick="showBoxCateHomeByID('#gadget','.box-mobile-content')"
                                   href="javascript:;">Gadget</a>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="clearfix list-products-category list-products-category-v1 float-left relative">
                        <div
                            ...
                            <div
                                ...
                                <div class="clearfix absolute name-product-no-ranking">
                                    <p class="title-product clearfix full-width title-hover-black"><a href="#">Cras
                                            sed
                                            quam vehicula</a></p>
                            ...
                            <div
                                ...
                                <div class="clearfix absolute name-product-no-ranking">
                                    <p class="title-product clearfix full-width title-hover-black"><a href="#">Est
                                            cu
                                            nibh clita</a></p>
                        ...
                        <div class="box-mobile-content border-collapsed-box animate-default hidden-content-box"
                            ...
                            <div
                                ...
                                <div class="clearfix absolute name-product-no-ranking">
                                    <p class="title-product clearfix full-width title-hover-black"><a href="#">Has
                                            eu
                                            idque similique</a></p>
                                    <p class="clearfix price-product"><span class="price-old">$500</span> $400</p>
                                </div>
            ...
            <div class=" container border top-padding-default bottom-padding-default">
                <div class="row">
                    <div class=" support-box-info relative col-md-3 col-sm-3 col-xs-6">
                        <img src="{{ asset('assets/img/icon_free_ship.png') }}" alt="Icon Free Ship"
                             class="absolute"/>
                        <p>free shipping</p>
                    ...
                    <div class=" support-box-info relative col-md-3 col-sm-3 col-xs-6">
                        <img src="{{ asset('assets/img/icon_phone_big.png') }}" alt="Icon Phone Tablet"
                             class="absolute">
                        <p>contact with us</p>
                        <p>+07 (0) 7782 9137</p>
                    </div>
